...
function ZThreat:UpdateTankDisplay(nThreat, sClose)
  self.wndMain:FindChild("Target"):SetText("AGGRO: " .. unitPlayer:GetName())
...
function ZThreat:UpdateDPSDisplay(nTopThreat, uTopThreat, ...)
  ...
  for i = 3, select('#', ...), 2 do
    ...
    if cUnit ~= nil and cUnit == unitPlayer then
...
function ZThreat:OnThreatUpdated(...)
  if select(1, ...) ~= nil then
    ...
    if topThreatUnit == unitPlayer then
